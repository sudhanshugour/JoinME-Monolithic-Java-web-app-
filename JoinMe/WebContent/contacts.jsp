...
<%
	...
	if (request.getMethod().equalsIgnoreCase("post")) {
		String unique_id = request.getParameter("searchContacts");
		int friend_id = new UserDAO().getUserID(unique_id);
		request.getRequestDispatcher("user_details.jsp?friend_id=" + friend_id).forward(request, response);
	}
%>
<html>
...
#authors .fa {UserDTO udto = new UserDTO();
	font-size: 25px;
}
...
<body class="w3-light-grey">
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 60px;">
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="info-header mb-5">
							<h1 class="text-primary mt-5 pb-3">My Contacts</h1>
							<p class="lead pb-3"></p>
						</div>
					</div>
				</div>
				...
				<div class="container mb-3">
					<div class="row justify-content-center">
						<div class="col-12 col-md-10 col-lg-8">
							<form autocomplete="off" action="contacts.jsp" method="post">
								<div class="autocomplete" style="width: 300px;">
									<input id="searchContacts" type="text" name="searchContacts"
										placeholder="Enter UserName">
								</div>
								<input type="submit" name="search1" value="Search Friend">
							</form>
						</div>
						<!--end of col-->
					</div>
				...
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								<form action="user_details.jsp" method="post">
									<img src="img/users/1 (<%=dto.getUser_id() % 82%>).jpg" alt=""
					...
					<%
							...
							out.print("No contacts added yet.");
						}
					%>
				</div>
			</div>
		...
		<jsp:include page="search/searchContacts.jsp"></jsp:include>
</body>
</html>
