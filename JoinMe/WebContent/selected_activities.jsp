...
<%
	...
	if (request.getMethod().equalsIgnoreCase("post")) {
		if (request.getParameter("delete") != null) {
			new SelectedActivityListDAO().deleteSelectedActivityList(
			...
			ArrayList<Integer> contacts = new ContactDAO().getContactList((int) session.getAttribute("user_id"));
			if (contacts != null) {
...
<html>
<title>Selected Activities</title>
<meta charset="UTF-8">
				...
				<div class="row">
					<div class="col">
						<div class="info-header mb-5">
							...
							<h1 class="text-primary mt-5 pb-3">Selected Activities</h1>
							<p class="lead pb-3">Here are your selected activities....</p>
						</div>
					</div>
				</div>
				<div class="row">
					<%
						...
						alADTO = adao.getSelectedActivities((int) session.getAttribute("user_id"));
						if (alADTO != null) {
					...
					<%
							...
							out.print("No activity is selected by you.....");
						}
					%>
				</div>
			</div>
