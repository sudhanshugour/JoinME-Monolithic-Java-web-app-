...
<%@page
	import="com.sjl.joinme.selected_activity_list.SelectedActivityListDTO"%>
<%@page
...
%>
<html>
<title>Activity Joined By</title>
<meta charset="UTF-8">
			...
			<div class="container">
				...
				<div class="row">
					...
					<%
						...
						selected_activity_list_contact = new SelectedActivityListDAO()
								.getAllSelectedActivityListWithActivityID(Integer.parseInt(request.getParameter("activity_id")));
						...
						<div class="card">
							<div class="card-body">
								<form action="user_details.jsp" method="post">
									<img src="img/users/1 (<%=udto.getUser_id()%>).jpg" alt=""
									...
									<p>
										@<%=udto.getUnique_id()%></p>
									<p>
										joined date : <%=sdto.getCreated_datetime()%></p>
									<p style="font: 200%">
										<%
											if (!sdto.getFeedback_message().isEmpty()) {
										%>
										FEEDBACK:<br><%=sdto.getFeedback_message()%></p>
									<%
										}
									%>
